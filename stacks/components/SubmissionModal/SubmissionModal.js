...
function SubmissionModal(props) {
  const { label, submitModalVisible, setSubmitModalVisible, onCancelSubmitModal, onConfirmSubmitModal } = props;
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <View style={styles.upperPart}>
            <Text style={styles.faceIDTextTop}>{t("overAll.submitTheTest")}</Text>
